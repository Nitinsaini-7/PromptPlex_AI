  ...
  const testimonials = [
    {
      ...
      quote:
        "Prompt Plex AI boosted my productivity by saving and optimizing prompts within seconds.",
    },
    {
      ...
      quote:
        "Prompt Plex AI makes organizing and reusing prompts effortless and helpful for my workflow.",
    },
    {
      ...
      quote:
        "Clean interface with fast response and reliable prompt management exactly what I needed daily.",
    },
    {
      avatar: "https://randomuser.me/api/portraits/men/86.jpg",
      name: "Micheal worin",
      title: "Product designer",
      quote:
        "Finally a tool that simplifies AI prompt creation and keeps everything neatly stored.",
    },
  ];
    ...
    <div className="mb-5">
      ...
      >
        {testimonials.map((item, index) => (
          <div
            key={index}
            className="mx-10 border border-gray-100 rounded-3xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group overflow-hidden"
          >
            <div className="relative p-6">
              ...
              <div className="relative mb-4">
                <svg
                  className="w-12 h-12 text-transparent bg-gradient-to-br from-indigo-400 to-purple-600 bg-clip-text opacity-80 group-hover:opacity-100 transition-opacity duration-300"
                  viewBox="0 0 35 35"
                  fill="none"
                ...
                <div className="absolute -top-1 -right-1 w-2 h-2 bg-gradient-to-br from-pink-400 to-purple-500 rounded-full opacity-60 animate-pulse"></div>
                <div className="absolute -bottom-2 -left-2 w-1.5 h-1.5 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full opacity-40 animate-pulse delay-150"></div>
              </div>
            </div>

            <figure className="relative">
              <blockquote className="relative z-10">
                <p className="text-gray-800 text-lg font-medium leading-relaxed px-6 py-2 group-hover:text-gray-900 transition-colors duration-300">
                  "{item.quote}"
                </p>
              </blockquote>

              {/* Enhanced author section with glass morphism effect */}
              <div className="relative mt-8 mx-4 mb-4 p-5 bg-gradient-to-br from-white/80 to-indigo-50/80 backdrop-blur-sm rounded-2xl border border-white/20 shadow-inner">
                {/* Subtle glow effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-400/5 to-purple-400/5 rounded-2xl"></div>
                ...
                <div className="relative flex items-center gap-4">
                  ...
                  <div className="relative">
                    <img
                      src={item.avatar}
                      className="w-16 h-16 rounded-full border-3 border-gradient-to-br from-indigo-400 to-purple-500 shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-105"
                  ...
                  <div className="flex-1">
                    <span className="block text-gray-900 font-bold text-lg group-hover:text-indigo-700 transition-colors duration-300">
                      {item.name}
                    </span>

    ...
    <div className="mb-5">
      ...
      >
        {testimonials.map((item, index) => (
          <div key={index} className=" mx-10 border border-gray-200 rounded-2xl">
            <div className="p-4">
              <svg
            ...
            <figure>
              <blockquote>
                <p className="text-gray-800 text-lg p-10 py-1">
                  {item.quote}
                </p>
              </blockquote>
              <div className="flex items-center gap-4 p-4 mt-6 bg-indigo-50 rounded-b-2xl">
                <img
                  src={item.avatar}
